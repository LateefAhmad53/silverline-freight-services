...
urlpatterns = [
    ...
    path("backend/receipts/generate/", views.generate_manual_receipt, name="generate_manual_receipt"),
    path("backend/receipts/<int:receipt_id>/edit/", views.edit_manual_receipt, name="edit_manual_receipt"),
    path("backend/receipts/<int:receipt_id>/download/", views.download_manual_receipt, name="download_manual_receipt"),
